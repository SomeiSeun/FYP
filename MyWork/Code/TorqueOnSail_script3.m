...
omega_dot_1(test+1) = rad2deg(T1/It);
omega_dot_2(test+1) = rad2deg(T2/It);

omega_1_10d(test+1) = omega_dot_1(test+1)*(10*day*60*60);
omega_2_10d(test+1) = omega_dot_2(test+1)*(10*day*60*60);

angle_1_10d(test+1) = (omega_dot_1(test+1)*(10*day*60*60)^2)/2;
angle_2_10d(test+1) = (omega_dot_2(test+1)*(10*day*60*60)^2)/2;

end
[omega_dot_1_max, index1] = max(omega_dot_1)
[omega_dot_2_max, index2] = max(omega_dot_1)
